...
enum Foursquare: Endpoint {
    ...
    enum VenueEndpoint: Endpoint {
        ...
        enum Category: CustomStringConvertible {
            case Bar([NightlifeSpotCategory]?)
            enum NightlifeSpotCategory: String {
                case Afghan = "4bf58dd8d48988d116941735"
            }
            var description: String {
                switch self {
                case .Bar(let categories):
...
final class FoursquareClient: APIClient {
    ...
    func fetchBarsFor(location: Coordinate, category: Foursquare.VenueEndpoint.Category, query: String? = nil, searchRadius: Int? = nil, limit: Int? = nil, completion: APIResult<[Venue]> -> Void) {
